...
exports.forgotPassword = catchAsync(async (req, res, next)=>{
    ...
    const message = `Forgot your password? Enter your new password and confirmPassword to: ${resetURL}`;
...
exports.resetPassword = catchAsync(async (req, res, next)=>{
    ...
    // 2. Check if  token has not expires and there is a user, set the new password
    if(!user){
